    ...
    <body>
        <div id="wrapper">
            ...
            <div id="main">
                ...
                <?php require_once('views/pages/1-home.php'); ?>
                <?php require_once('views/pages/2-inhaltsverzeichnis.php'); ?>
                <?php require_once('views/pages/3-abbildungen.php'); ?>
                <?php require_once('views/pages/4-photos.php'); ?>
                <?php require_once('views/pages/5-biographie.php'); ?>
                <?php require_once('views/pages/6-ausstellungen.php'); ?>
                <?php require_once('views/pages/7-bibliographie.php'); ?>
                <?php require_once('views/pages/8-noah-odysseus.php'); ?>
                <?php require_once('views/pages/9-arbeitstechnik.php'); ?>
                <?php require_once('views/pages/10-kontakt.php'); ?>
                <?php require_once('views/pages/11-stiftung.php'); ?>
                <?php require_once('views/pages/12-mein-erstes-buch.php'); ?>
                <?php require_once('views/pages/13-museum-in-cachoeira.php'); ?>
                <?php require_once('views/pages/14-presse.php'); ?>
                <?php require_once('views/pages/15-katalog-1946-1970.php'); ?>
                <?php require_once('views/pages/16-essay-uber-leben-und-werk.php'); ?>
                <?php require_once('views/pages/17-eine-autobiographische-betrachtung.php'); ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3" id="sort">
                                            ...
                                            <div class="btn-group pull-right"> 
                                                ...
                                                <button type="button" data-sort="data-year" data-order="desc" class="sort btn btn-default"><i class="fa-sort-by-order"></i></button>
                                                <button type="button" data-sort="data-year" data-order="asc" class="sort btn btn-default"><i class="fa-sort-by-order-alt"></i></button>
                                            </div>
                                        </div>    
                                    </div>
                                </div>
                    ...
                    <div class="pagecontents">
                        ...
                        <div class="section color-1">
                            <div class="section-container">
                                <div class="row">
                                    <div class="col-md-4 text-center hidden-xs hidden-sm">
                                        <i class="fa fa-stethoscope fa fa-huge"></i>
                                    </div>
                                    <div class="col-md-8">
                        ...
                        <div class="section contact-lab" data-stellar-background-ratio="0.1">
                            <div class="section-container">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 text-center hidden-xs hidden-sm">
                                        <i class="fa fa-superscript fa fa-huge"></i>
                                    </div>
...
<script type="text/javascript">
                                        var list, index, anav;
                                        list = document.getElementsByClassName("linav");
                                        anav = document.getElementsByClassName("anav");
                                        for (index = 0; index < list.length; ++index) {
                                            list[index].setAttribute('style','background:#FDFDFD;border-top:none;border-bottom:none;');
                                            anav[index].setAttribute('style','font-size: 16px;color:#000;');
                                        }
                                        </script>
